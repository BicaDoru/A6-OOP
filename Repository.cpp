...
{
    Tutorial demoTutorial1("Learn C++", "Unknown Artist", "www.youtube.com", 1000, Duration(30, 15));
    Tutorial demoTutorial2("Make C++ easy", "Ricardo Villalobos", "www.youtube.com", 657, Duration(120, 0));
    Tutorial demoTutorial3("Intro in C++", "Tech with Tim", "www.youtube.com", 2314, Duration(45, 35));
    Tutorial demoTutorial4("C++ for beginners", "Crazy Russian Hacker", "www.freecodecamp.com", 1000, Duration(72, 55));
    ...
    Tutorial demoTutorial9("Algorithms in C++", "Gojnea76", "www.youtube.com", 4234, Duration(30, 15));
    Tutorial demoTutorial10("Hacking with C++", "ZefZeed", "www.youtube.com", 5103, Duration(140, 23));
